...
### 🏥 4. Sistema de Monitoramento Hospitalar Híbrido (SQL + NoSQL)

 Projeto desenvolvido em grupo simulando o ecossistema de dados de um hospital moderno, utilizando uma arquitetura híbrida para combinar integridade transacional e alta escalabilidade. O sistema utiliza MySQL para dados estruturados (pacientes, profissionais, consultas e regras de negócio) e MongoDB para armazenamento de dados de sensores IoT em tempo real (batimentos cardíacos, oxigenação e pressão). O projeto inclui geração de massa de dados com Python, simulação de dispositivos médicos e um dashboard interativo em Streamlit para visualização clínica. Também foram implementados recursos avançados de banco de dados, como triggers de auditoria e stored procedures, evidenciando domínio de modelagem relacional e integração SQL/NoSQL.

- 🔗 Projeto: (https://github.com/Scher-er/Banco-de-Dados-II)
